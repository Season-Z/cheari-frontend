    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: '/report',
            element: <LazyImportComponent lazyChildren={lazy(() => import('@/pages/study/report'))} />,
            options: {
              title: '生成报告',
            },
          },
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: '/comprehensive/technical-training/:id',
            element: (
              <LazyImportComponent
          ...
          {
            path: '/comprehensive/information/:id',
            element: (
